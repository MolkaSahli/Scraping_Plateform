...
$('#wizard').smartWizard({
  ...
  // Events
    ...
    toolbarSettings: {
    toolbarButtonPosition: 'end', // Position of the toolbar buttons
    showNextButton: true,  // Show the Next button (you will modify it later)
    showPreviousButton: true,  // Show the Previous button
  }
});

// Replace the Next button with a Submit button after initialization
$(document).ready(function() {
  // Change the "Next" button to a "Submit" button
  $(".sw-btn-next").replaceWith('<input type="submit" class="sw-btn-submit">Next</button>');
});
```
